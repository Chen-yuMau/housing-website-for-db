...
<html lang="en">
    ...
    <body>
		...
		?>
		<form method="post" action = "delete2.php" id="delete"></form>
		<h1>My Houses</h1>
		<form style = "width: 15%;" action = "newhouse.html" id="new"><!-- -->
		</form>
		<form style = "width: 15%;" action = "edit.php" id="edit">
    	</form>
    	...
    	<table width="100%">
	          	<tr>
		            ...
		            <td>
						<button  style="width:200px" class="submit" type="submit" class="submit" form="edit">Edit</button>
					</td>
					<td></td>
					<td></td>
					<td></td>
