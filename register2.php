...
<html>
	...
	<h1><strong>Please Fill In The Following To Register</strong></h1>
 		<form action="register.php" method="post">
			<br/><br/>
			<input name="Account" placeholder=<?php echo $_SESSION['new_account']?> type="text" required />
			<br/>
			<input name="Password1" value=<?php echo $_SESSION['new_password1']?> type="password" required />
			<br/>
			<input name="Password2" value=<?php echo $_SESSION['new_password2']?> type="password" required />
			<br/>
